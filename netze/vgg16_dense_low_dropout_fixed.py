...
def nn_base(img_input, trainable=False):
    ...
    # Block 4
    x = Conv2D(512, (3, 3), activation='relu', padding='same', trainable=False, name='block4_conv1')(x)
...
def classifier(base_layers, input_rois, num_rois, nb_classes = 21, trainable=False):
    ...
    out = TimeDistributed(Dense(2048, activation='relu', name='fc1_'))(out)
    out = TimeDistributed(Dropout(0.5))(out)
    out = TimeDistributed(Dense(2048, activation='relu', name='fc2_'))(out)
    out = TimeDistributed(Dropout(0.5))(out)
