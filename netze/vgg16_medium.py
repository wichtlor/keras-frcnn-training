...
def nn_base(img_input, trainable=False):
    ...
    x = Conv2D(192, (3, 3), activation='relu', padding='same', name='block3_conv2')(x)
    x = Conv2D(192, (3, 3), activation='relu', padding='same', name='block3_conv3')(x)
    ...
    # Block 5
    x = Conv2D(320, (3, 3), activation='relu', padding='same', name='block5_conv1')(x)
    x = Conv2D(320, (3, 3), activation='relu', padding='same', name='block5_conv2')(x)
    x = Conv2D(320, (3, 3), activation='relu', padding='same', name='block5_conv3')(x)
