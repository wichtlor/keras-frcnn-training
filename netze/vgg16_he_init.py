...
def classifier(base_layers, input_rois, num_rois, nb_classes = 21, trainable=False):
    ...
    out = TimeDistributed(Dense(4096, kernel_initializer='he_normal', activation='relu', name='fc1'))(out)
    out = TimeDistributed(Dropout(0.5))(out)
    out = TimeDistributed(Dense(4096, kernel_initializer='he_normal', activation='relu', name='fc2'))(out)
    out = TimeDistributed(Dropout(0.5))(out)
